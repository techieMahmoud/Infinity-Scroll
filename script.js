...
const apiKey = '2faI4k2HEXCP4qjzEo2QlieyBdKSa9wobpoaBIb8knM';
const apiUrl = `https://api.unsplash.com/photos/random/?client_id=${apiKey}&count=${initialCount}`;

// updating the API URL counter for performance optimization
...
// Check if scrolling near bottom of the page to load more photos
